...
ADMINS = (
    ...
    ('Patrick Michaud', 'pmichaud@uw.edu'),
    ('Cole Bessee', 'cbessee@uw.edu'),
    ('Ali Haugh', 'haughar@uw.edu'),
#    ('Mike Seibel', 'mikes@uw.edu'),
#    ('Nina Bohn', 'tbohn@uw.edu'),
)
...
FEEDBACK_EMAIL_RECIPIENT = ['spacescouthelp@uw.edu']
DEFAULT_FROM_EMAIL = 'noreply@spacescout.edu' # If the user doesn't specify an email address when they report a problem
...
SS_PUBLISHER_EMAIL = [ 'spacescoutadmin@uw.edu' ]
        
# Email subject of publication requests  
SS_PUBLISHER_FROM = 'spacescout_admin@spotseeker-test.cac.washington.edu'
...
USER_EMAIL_DOMAIN = "uw.edu"

# LDAP server to search
SS_LDAP_DIRECTORY = 'people.u.washington.edu'

# LDAP search parameters
SS_LDAP_SEARCH_BASE = 'o=University of Washington,c=US'

LABSTATS_URL = 'http://stf-k2.cac.washington.edu/LabStats/WebServices/Statistics.asmx?WSDL'
